 ...
 *  main action on a screen; `outline` a secondary one; `danger` confirms a
 *  destructive action; `dangerText` offers one without drawing the eye. */
export type ButtonVariant = 'primary' | 'outline' | 'danger' | 'dangerText';
...
const VARIANT_CLASS: Record<ButtonVariant, string> = {
  ...
  dangerText: 'text-error hover:bg-border-subtle',
};
